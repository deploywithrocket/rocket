<template>
    <label class="block">
        ...
        <select class="w-full px-3 py-3 text-sm leading-tight text-gray-700 transition duration-200 ease-in-out bg-gray-100 rounded appearance-none focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-pink-500"
