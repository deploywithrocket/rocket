<template>
    <label class="block">
        ...
        <textarea class="w-full px-3 py-3 text-sm leading-tight text-gray-700 bg-gray-100 border rounded appearance-none focus:outline-none focus:shadow-outline"
                :class="{ 'border-red-500 mb-1': errors.length, 'font-mono': mono }"
                v-bind="$attrs"
