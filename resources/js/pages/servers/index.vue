    ...
    <div>
        ...
        <div class="p-8 bg-white rounded-lg shadow">
            <div class="flex justify-between mb-8">
                <inertia-link :href="$route('servers.create')" class="inline-block px-4 py-2 text-sm font-semibold text-white transition duration-150 ease-in-out bg-pink-500 rounded-lg hover:bg-pink-600">
            ...
            <div class="grid grid-cols-1 gap-4 mb-8 lg:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4">
                <div v-for="server in servers.data" v-bind:key="server.id" class="p-4 border rounded">
                    ...
                    <div class="flex flex-row space-x-2">
                        ...
                        <inertia-link class="inline-block px-4 py-2 text-sm font-semibold text-gray-600 transition duration-150 ease-in-out bg-gray-100 rounded-lg hover:bg-gray-200" :href="$route('servers.connection', server)"><i class="fas fa-fw fa-link"></i></inertia-link>
            ...
            <div class="flex justify-between">
                <inertia-link
                    ...
                    class="inline-block px-4 py-2 text-sm font-semibold text-gray-600 transition duration-150 ease-in-out bg-gray-100 rounded-lg hover:bg-gray-200"
                >
