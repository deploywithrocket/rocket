            ...
            <div class="flex flex-col items-start w-full mb-8 overflow-hidden bg-white rounded shadow-sm">
                ...
                <div class="w-full px-5 py-4 text-sm bg-gray-50">
                    <div class="flex justify-end">
                        <button type="button" class="inline-block px-4 py-2 text-sm font-semibold text-gray-600 transition duration-150 ease-in-out bg-gray-200 rounded-lg hover:bg-gray-300" @click="$inertia.post($route('servers.connection.test', server))"><i class="mr-1 fas fa-link"></i> Test connection status</button>
                    </div>
                </div>
            </div>
        </div>
