<template>
    <div class="max-w-sm p-8 mx-auto bg-white rounded-lg shadow lg:max-w-3xl">
        ...
        <div v-if="!github_account">
            ...
            <a href="/auth/github" class="inline-block px-4 py-2 text-sm font-semibold text-gray-600 transition duration-150 ease-in-out bg-gray-100 rounded-lg hover:bg-gray-200"><i class="fab fa-github"></i> Connect to GitHub</a>
        </div>
        <div v-else>
