            ...
            <div class="flex flex-col items-center justify-center w-full">
                                ...
                                <div class="flex flex-col items-start justify-start w-full h-full bg-white rounded-3xl">
                                    ...
                                    <div class="w-full mt-auto">
                                        <div class="flex flex-col items-end justify-end p-4 ml-auto text-white">
                                            <div class="px-3 py-2 mb-2 bg-orange-500 rounded-lg" v-for="(message, k) in messages" v-bind:key="k">
                                                {{ message }}
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="w-full max-w-md p-8 bg-white rounded-lg shadow">
                    ...
                    <div class="flex justify-end mt-8">
                        <button class="px-4 py-2 text-sm font-semibold text-white bg-orange-500 rounded hover:bg-orange-600 focus:outline-none">Edit</button>
                    </div>
                </div>
            </div>
        </form>
