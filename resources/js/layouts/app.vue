<template>
    <div class="flex flex-col items-start min-h-screen bg-gray-100">
        <nav class="w-full mb-8 bg-white border-b border-gray-200">
            <div class="container max-w-screen-xl">
                <div class="flex flex-wrap items-center">
                    ...
                    <button class="ml-auto md:hidden focus:outline-none" @click="toggle">
                    ...
                    <div :class="open ? 'flex': 'hidden'" class="flex-col flex-grow w-full py-2 -mx-1 md:flex md:py-0 md:flex-row md:items-center md:w-auto md:pl-8">
                        <inertia-link :href="$route('servers.index')" class="inline-block px-4 py-2 mx-1 mb-2 text-sm font-semibold text-gray-600 transition duration-150 ease-in-out bg-gray-100 rounded-lg md:mb-0 hover:bg-gray-200"><i class="mr-1 opacity-75 fas fa-server"></i> Servers</inertia-link>
                        <inertia-link :href="$route('projects.index')" class="inline-block px-4 py-2 mx-1 mb-2 text-sm font-semibold text-gray-600 transition duration-150 ease-in-out bg-gray-100 rounded-lg md:mb-0 hover:bg-gray-200"><i class="mr-1 opacity-75 fas fa-folder"></i> Projects</inertia-link>

                        <div class="hidden ml-auto md:block"></div>

                        <button type="button" class="inline-block px-4 py-2 mx-1 mb-2 text-sm font-semibold text-left text-gray-600 transition duration-150 ease-in-out bg-gray-100 rounded-lg md:mb-0 hover:bg-gray-200" @click="$inertia.post($route('logout'))"><i class="mr-1 opacity-75 fas fa-sign-out-alt"></i> Sign out</button>
                    </div>
                </div>
            </div>
        </nav>
        ...
        <footer class="w-full px-4 py-8 mt-auto text-xs text-center text-gray-400">
            &copy; 2020-2021 - <a href="https://deploywithrocket.dev">Rocket</a> {{ $page.version }}
        </footer>
    </div>
</template>
